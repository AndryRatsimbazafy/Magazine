            ...
            <div class="main-content">
              <div class="section__content section__content--p30">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-lg-6">
                      <h1 class="pb-2 display-4">Edit Item</h1>
                        <div class="card">
                          <div class="card-header">
                              <strong>Editing an item Form</strong>
                          </div>
                          <form action="<?php echo base_url() ?>index.php?c=Admin&m=editItem" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input value="<?php echo $post['Titre'] ?>" type="text" id="Title" name="Title" placeholder="Title" class="form-control">
                                    <input value="<?php echo $post['IdPost'] ?>" type="hidden" id="Title" name="idPost" class="form-control">
                                </div>
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input value="<?php echo $post['SousTitre'] ?>" type="text" id="SubTitle" name="SubTitle" placeholder="Sub Title" class="form-control">
                                </div>
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3">
